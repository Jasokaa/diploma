...
const getWishlistScenarioByKey = (key) => {
  if (key === "custom") {
    return null;
  }
  return wishlistScenarioOptions.find((scenario) => scenario.key === key) || null;
};
const detectWishlistScenario = (values) => {
...
const formatWishlistScenario = (key) => {
  if (key === "custom") {
...
export { getWishlistScenarioByKey as a, wishlistThemeOptions as b, customScenarioOption as c, detectWishlistScenario as d, formatWishlistScenario as f, getWishlistThemeStyle as g, wishlistScenarioOptions as w };
//# sourceMappingURL=wishlistScenarios-Bq5lbsHk.mjs.map
